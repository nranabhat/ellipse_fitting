...
PLOT_MLE = True
loader = loadCSVdata_var_contrast.loadCSVdata(NUM_ELLIPSES, NUM_POINTS, FULL_PHI_RANGE, LAB_COMP, VARIABLE_CONTRAST)
...
train_loss=0.025
LS_test_loss=0.00061
MLE_test_loss = 0.0002
...
#       4. LS   [phi_d]         values
nine_plot = plot_nine(PLOT_MLE, input_coords, target_params,
                      outputs, Phi_LS,
                      test_loss, test_phase_loss=torch.tensor(0.0001), train_loss=0.0002, LS_test_loss=0.0003, MLE_test_Loss = 0.000004, 
                      CLAMP_EPSILON=0)
nine_plot.show()

#errors_plot = plot_errors(target_params, outputs, Phi_LS, Phi_MLE, PLOT_MLE)
#errors_plot.show()
