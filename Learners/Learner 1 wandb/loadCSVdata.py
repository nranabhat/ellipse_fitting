...
class loadCSVdata:
    def __init__(self, NUM_TRAINING_ELLIPSES, numPoints):

        self._NUM_TRAINING_ELLIPSES = NUM_TRAINING_ELLIPSES
        self._numPoints = numPoints
        numTestingEllipses = 100
        numParameters = 6
        self._shape_training_data = [numPoints,NUM_TRAINING_ELLIPSES]
        self._shape_training_labels = [NUM_TRAINING_ELLIPSES,numParameters]
        self._shape_testing_data = [numPoints,numTestingEllipses]
        ...
        self._datasets_path = r"C:\Users\Nicor\OneDrive\Documents\KolkowitzLab\Ellipse fitting\Datasets\Updated Contrast Datasets"
