...
#NAME_OF_ARTIFACT_TO_USE = 'nicoranabhat/ellipse_fitting/best-run2-phi-'+RUN_ID+'-'+NUM_TRAINING_ELLIPSES+'-trainingEllipses.pt:'+str(VERSION_NUM)
NAME_OF_ARTIFACT_TO_USE = 'nicoranabhat/ellipse_fitting/best-mlp-sweep-phi-'+RUN_ID+'.pt:'+str(VERSION_NUM)
LOG_NEW_ARTIFACT_TO = f'best-run-phi'+str(RUN_ID)+'-'+NUM_TRAINING_ELLIPSES+'-trainingEllipses.pt'
